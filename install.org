...
*** pacman
#+begin_src shell :tangle yes
WM=("feh" "haskell-dbus" "picom" "xmonad" "xmonad-contrib" "xmonad-utils")
RUNLANCHER=("rofi" "clipmenu" "pass")
MULTIMEDIA=("lollypop" "vlc" "youtube-dl")
OFFICE=("libreoffice-fresh" "hunspell" "aspell" "aspell-en")
TERMINAL=("alacritty" "fish" "zsh")
...
*** AUR
#+begin_src shell :tangle yes
WM_AUR=("polybar" "xmonad-log")
RUNLANCHER_AUR=("j4-dmenu-desktop")
MULTIMEDIA_AUR=("ani-cli" "spotify")
LOGINMANAGER_AUR=("ly")
...
*** servics
#+begin_src shell :tangle yes
LOGINMANAGER_SERVS=("smb.service")
#+end_src
** utilites
*** pacman
#+begin_src shell :tangle yes
...
*** pacman
#+begin_src shell :tangle yes
THEMEING_APP=("lxappearance " "kvantum")
#+end_src
*** AUR
#+begin_src shell :tangle yes
THEMEING_APP_AUR=("starship")
THEME_AUR=("sweet-gtk-theme-dark" "kvantum-theme-sweet-git")
ICONS_AUR=("beautyline")
CURSOR_AUR=("sweet-cursor-theme-git")
#+end_src
* installing base-devel and xorg if not installed
#+begin_src shell :t :tangle yes
HELPER="paru-bin"
HELPER_CMD="paru"
...
#+begin_src shell :tangle yes
mkdir ~/Documents
mkdir ~/Documents/bare-repo
cd ~/Documents/bare-repo
git clone --bare https://github.com/Haam-z/DotFiles.git
git --git-dir=$HOME/Documents/bare-repo/DotFiles.git --work-tree=$HOME checkout -f
cd ~
kvantummanager --set Sweet
sudo kvantummanager --set Sweet
